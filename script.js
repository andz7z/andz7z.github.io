...
const WORK_ITEMS = {
  season: {
    ...
    features: ["LUA Mod", "No FPS Drop", "Summer to Winter"]
  },
  weather: {
    title: "Weather Shift",
    ...
    features: ["LUA Mod", "Weather or Time", "Day to Night"]
  },
  tags: {
    title: "Modern Tags",
    ...
    features: ["Customizable", "Modern Look", "Custom fonts support"]
  },
  look: {
    title: "Look Changer",
    ...
    features: ["No FPS Drop", "Select/Remove", "Any Skin"]
  }
};
