...
const WORK_ITEMS = {
  season: {
    ...
    features: ["Instant", "Local Saving", "No FPS Impact]
  },
  weather: {
    title: "Weather Shift",
    img: "https://i.imgur.com/nstY5n2.jpeg",
    desc: "A mod to instantly change the time from day to night or from afternoon to morning. The transition is smooth, taking you through every minute/hour in just one second. Works with Season Flow for best results.",
    github: "https://github.com/andz7z/TIMECHANGER-GTA-SA",
    features: ["Custom Time/Min", "Weather presets", "LUA Mod"]
  },
  tags: {
    title: "Modern Tags",
    ...
    features: ["Custom Colors", "Custom Fonts", "Custom Icons"]
  },
  look: {
    title: "Look Changer",
    ...
    features: ["Instant", "No FPS Drops", "Save custom skins"]
  }
};
