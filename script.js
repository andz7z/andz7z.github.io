...
async function fetchYouTubeStats() {
  try {
    ...
    const lightThumb = "https://github.com/andz7z/andz7z.github.io/assets/logos/logo_light.gif";
    const darkThumb = "https://github.com/andz7z/andz7z.github.io/assets/logos/logo_light.gif";
...
window.addEventListener("load", fetchYouTubeStats);
  ...
  // ======== Music Control ========
  // ===========================================================
  const music = new Audio("https://github.com/andz7z/andz7z.github.io/assets/sounds/song.MP3");
  const clickSound = new Audio("https://github.com/andz7z/andz7z.github.io/assets/sounds/click.MP3");
...
function showNotification(type = "info", message = "🏡 Make yourself like home", duration = 11000) {
  ...
  // Play sound
  const notifSound = new Audio("https://github.com/andz7z/andz7z.github.io/assets/sounds/notification.MP3");
