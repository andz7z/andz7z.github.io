/* ========================================
   ...
   Video background, animations, and home-specific interactions
   ======================================== */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initVideoOptimization() {
        if (backgroundVideo) {
            ...
            backgroundVideo.addEventListener('error', function() {
                ...
                // The page will still work without video
            });
        }
    }
    ...
    function initScrollAnimations() {
        ...
        function updateScrollAnimations() {
            ...
            if (homeSection && scrollY < window.innerHeight) {
                ...
                if (overlay) {
                    const opacity = 0.4 + (scrollY / window.innerHeight) * 0.3;
    ...
    function initKeyboardNavigation() {
        document.addEventListener('keydown', function(e) {
            ...
            if (e.key === 'Escape') {
                if (window.ANDZ && window.ANDZ.closeMobileMenu) {
                    window.ANDZ.closeMobileMenu();
                }
            }
        });
    }
    ...
    function initPerformanceMonitoring() {
        ...
        const scrollHandler = () => {
            ...
            if (scrollCount % 100 === 0) {
                console.log('Scroll performance check:', scrollCount);
            }
        };
