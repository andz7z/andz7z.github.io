...
function renderPage(){
  try {
    ...
    visible.forEach(r => {
      ...
      const img = `https://andz7z.github.io/assets/logos/reviews/${r.gender || 'male'}.gif`;
      ...
      db.ref(`reviews/${r.id}/replies`).on('value', snap => {
        ...
        arr.forEach(rep => {
          ...
          const img = `https://andz7z.github.io/assets/logos/reviews/${rep.gender || 'male'}.gif`;
...
function renderRepliesTreeFragment(nodes, reviewId, depth){
  ...
  nodes.forEach(node => {
    ...
    const img = `https://andz7z.github.io/assets/logos/reviews/${node.gender || 'male'}.gif`;
